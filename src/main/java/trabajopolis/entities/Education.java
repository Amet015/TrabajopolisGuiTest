...
public class Education {
    ...
    private static final String LANGUAGE_WRITTEN = "Language Written";
    private static final String LANGUAGE_ORAL = "Language Oral";
    private static final String LANGUAGE_READING = "Language Reading";
